...
function ensureStyle() {
  ...
  style.id = styleId;
  style.textContent = `
.barcode-focus-pulse{box-shadow:0 0 0 3px rgba(21,148,71,.18)!important;border-color:#159447!important}.barcode-scan-flash{position:fixed;left:50%;top:84px;z-index:9997;transform:translateX(-50%) translateY(-8px);opacity:0;pointer-events:none;display:flex;align-items:center;gap:8px;padding:9px 13px;border-radius:999px;background:rgba(21,148,71,.94);color:#fff;font-weight:900;font-size:.9rem;box-shadow:0 14px 34px rgba(15,23,42,.22);transition:opacity .14s ease,transform .14s ease}.barcode-scan-flash.show{opacity:1;transform:translateX(-50%) translateY(0)}.barcode-scan-flash svg{width:18px;height:18px;fill:none;stroke:currentColor;stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}@media(max-width:600px){.barcode-scan-flash{top:72px;font-size:.82rem;padding:8px 11px}}
`;
...
function flash(message = 'เพิ่มสินค้าแล้ว') {
  ...
  if (!el) {
    ...
    el.innerHTML = '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><path d="m8.5 12.2 2.2 2.2 4.8-5"></path></svg><span></span>';
