...
function renderMenus() {
  ...
  currentPage = Math.min(currentPage, totalPages);
  const pageItems = isMobile() ? filtered : filtered.slice((currentPage - 1) * size, currentPage * size);
