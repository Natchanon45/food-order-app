...
function addPadStyle() {
  ...
  style.textContent = `@media(min-width:801px){.payment-form.has-pos-pad{width:min(760px,calc(100vw - 64px));max-width:760px;display:grid;grid-template-columns:minmax(0,1fr)210px;grid-template-areas:"head head" "total pad" "customer pad" "method pad" "received pad" "change pad" "error error" "actions actions";gap:10px 12px;align-items:start;overflow-x:hidden}.payment-form.has-pos-pad .dialog-head{grid-area:head}.payment-form.has-pos-pad .payment-total{grid-area:total;display:flex;align-items:center;justify-content:space-between;gap:14px;padding:18px 20px;border-radius:18px;background:#eaf7ef;border:1px solid #ccebd8}.payment-form.has-pos-pad .payment-total span{font-size:14px;font-weight:900;color:#1f5131}.payment-form.has-pos-pad .payment-total strong{font-size:30px;font-weight:1000;color:#062d16;letter-spacing:-.03em}.payment-form.has-pos-pad .customer-picker{grid-area:customer;min-width:0}.payment-form.has-pos-pad label:has(#paymentMethod){grid-area:method}.payment-form.has-pos-pad #receivedWrap{grid-area:received}.payment-form.has-pos-pad .change-row{grid-area:change;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 2px}.payment-form.has-pos-pad .change-row span{font-size:14px;font-weight:900;color:#1f2937}.payment-form.has-pos-pad .change-row strong{font-size:24px;font-weight:1000;color:#dc2626}.payment-form.has-pos-pad #paymentError{grid-area:error}.payment-form.has-pos-pad .dialog-actions{grid-area:actions}.payment-form.has-pos-pad input,.payment-form.has-pos-pad select{min-width:0}.pos-number-pad{grid-area:pad;position:sticky;top:8px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;padding:10px;border:1px solid #dfeae3;border-radius:18px;background:#f8fcfa;z-index:1;min-width:0;align-self:start}.pos-number-pad-title{display:none!important}.pos-number-pad button{appearance:none!important;-webkit-appearance:none!important;min-width:0;min-height:44px;border:1px solid #dbe7df;border-radius:13px;background:#fff!important;background-image:none!important;color:#102317;font-family:inherit!important;font-size:17px;font-weight:900;line-height:1;touch-action:manipulation;padding:0 6px;display:inline-grid!important;place-items:center!important;text-indent:0!important}.pos-number-pad button::before,.pos-number-pad button::after,.pos-number-pad button i,.pos-number-pad button svg{content:none!important;display:none!important;visibility:hidden!important;width:0!important;height:0!important;margin:0!important}.pos-number-pad button:hover{border-color:#9fd0b3;background:#effaf3!important}.pos-number-pad .is-action{color:#0d6f34;background:#eef8f1!important;font-size:14px}.pos-number-pad .is-danger{color:#b42318;background:#fff3f3!important;border-color:#ffd0d0;font-size:14px}.pos-number-pad .is-wide{grid-column:span 2}.pos-number-pad .is-primary{color:#fff;background:#159447!important;border-color:#159447;font-size:15px}.payment-form.has-pos-pad .customer-search-results{z-index:20;max-width:100%}}@media(max-width:800px){.pos-number-pad{display:none!important}}`;
