...
function printCurrentReceipt() {
  ...
  popup.document.write(`<!doctype html><html lang="th"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>พิมพ์บิล</title><style>body{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;margin:0;padding:10px;color:#111}.receipt-paper{width:80mm;max-width:100%;margin:0 auto}.receipt-center{text-align:center}.receipt-shop{font-weight:900;font-size:18px}.receipt-muted{color:#555;font-size:12px}.receipt-rule{border:0;border-top:1px dashed #999;margin:10px 0}.receipt-row{display:flex;justify-content:space-between;gap:10px;margin:5px 0}.receipt-item{display:grid;grid-template-columns:1fr auto;gap:8px;margin:7px 0}.receipt-item small{display:block;color:#555}.receipt-total{font-size:17px;font-weight:900}@media print{body{padding:0}.receipt-paper{width:80mm}}</style></head><body>${receiptHtml(sale)}<script>window.onload=()=>{window.focus();window.print();setTimeout(()=>window.close(),500)}<\/script></body></html>`);
