...
@media(min-width:901px){body{background:#eaf2e8!important}body:before{content:"";position:fixed;inset:0;pointer-events:none;background:radial-gradient(circle at 50% 0%,rgba(21,148,71,.10),transparent 34rem)}.pos-header,.pos-layout{width:min(100%,460px)!important;margin-left:auto!important;margin-right:auto!important}.pos-header{min-height:72px!important}.pos-layout{display:grid!important;grid-template-columns:1fr!important;gap:8px!important;padding:8px!important;min-height:auto!important}.cart-panel{min-height:520px!important}.product-panel .section-heading{display:grid!important;grid-template-columns:1fr!important;gap:10px!important}.section-actions{display:grid!important;grid-template-columns:1fr 1fr!important;width:100%!important;gap:8px!important}.section-actions .btn{width:100%!important;min-height:42px!important}.search-row{grid-template-columns:1fr!important;gap:8px!important}.product-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important}.product-card{min-height:120px!important}.app-version-badge{right:calc(50% - min(230px,50vw) + 10px)!important;bottom:10px!important}}
`;
