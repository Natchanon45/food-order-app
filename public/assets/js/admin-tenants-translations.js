    ...
    "th": {
        "admin_tenants": {
            ...
            "review": {
                ...
                "submitted": "ส่งเมื่อ",
                "view_slip": "ดู",
                "ocr_matched": "Vision OCR: ยอดตรงกัน :amount บาท",
                "ocr_mismatch": "Vision OCR: พบยอด :amount บาท ไม่ตรงกับยอดที่ต้องโอน",
                "ocr_unreadable": "Vision OCR: อ่านยอดเงินไม่ได้ กรุณาตรวจด้วยคน",
                "ocr_manual": "Vision OCR: ต้องตรวจด้วยคน",
    ...
    "en": {
        "admin_tenants": {
            ...
            "review": {
                ...
                "submitted": "Submitted",
                "view_slip": "View",
                "ocr_matched": "Vision OCR: amount matched THB :amount",
                "ocr_mismatch": "Vision OCR: detected THB :amount, which does not match the amount due",
                "ocr_unreadable": "Vision OCR: amount could not be read; manual review required",
                "ocr_manual": "Vision OCR: manual review required",
