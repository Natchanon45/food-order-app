    ...
    "th": {
        "admin_tenants": {
            ...
            "share": {
                ...
                "recipient_name": "ชื่อผู้รับเงิน / ชื่อบริษัท",
                "recipient_name_placeholder": "เช่น นาย ณัฐชนน ศรีเปล่ง หรือ บริษัท ตัวอย่าง จำกัด",
                "recipient_name_help": "ระบบจะตรวจว่าชื่อนี้ปรากฏในสลิป โดยไม่สนใจช่องว่าง จุด หรือขีด",
                "recipient_name_required": "กรุณากรอกชื่อผู้รับเงินหรือชื่อบริษัทก่อนเปิดใช้งานส่วนแบ่ง",
                "billing_cycles": {
                    "daily": "รายวัน",
                    "monthly": "รายเดือน"
                },
            ...
            "review": {
                ...
                "submitted": "ส่งเมื่อ",
                "view_slip": "ดู",
                "ocr_matched": "ระบบ: ยอดตรงกัน :amount บาท",
                "ocr_mismatch": "ระบบ: พบยอด :amount บาท ไม่ตรงกับยอดที่ต้องโอน",
                "ocr_unreadable": "ระบบ: อ่านยอดเงินไม่ได้ กรุณาตรวจด้วยคน",
                "ocr_manual": "ระบบ: ต้องตรวจด้วยคน",
                "recipient_matched": "ผู้รับตรงกับ :recipient",
                "recipient_mismatch": "ไม่พบชื่อผู้รับ :recipient ในสลิป",
                "recipient_manual": "ชื่อผู้รับ :recipient ต้องตรวจด้วยคน",
                "recipient_not_configured": "ยังไม่ได้กำหนดชื่อผู้รับเงินในระบบ",
    ...
    "en": {
        "admin_tenants": {
            ...
            "share": {
                ...
                "recipient_name_placeholder": "For example: Mr. Natchanon Sripleng or Example Co., Ltd.",
                "recipient_name_help": "The system checks that this name appears on the slip, ignoring spaces, periods, and hyphens.",
                "recipient_name_required": "Enter the recipient or company name before enabling revenue share.",
                "billing_cycles": {
                    "daily": "Daily",
                    "monthly": "Monthly"
                },
            ...
            "review": {
                ...
                "submitted": "Submitted",
                "view_slip": "View",
                "ocr_matched": "System: amount matched THB :amount",
                "ocr_mismatch": "System: detected THB :amount, which does not match the amount due",
                "ocr_unreadable": "System: amount could not be read; manual review required",
                "ocr_manual": "System: manual review required",
                "recipient_matched": "Recipient matched: :recipient",
                "recipient_mismatch": "Recipient :recipient was not found on the slip",
                "recipient_manual": "Recipient :recipient requires manual review",
                "recipient_not_configured": "No recipient name has been configured",
