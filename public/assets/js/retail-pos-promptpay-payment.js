...
function ensureStyle() {
  ...
  style.textContent = `
    ...
    @media(min-width:801px){#paymentDialog:has(.payment-form.has-pos-pad){width:min(840px,calc(100vw - 56px))!important;max-width:840px!important}#paymentDialog .payment-form.has-pos-pad{grid-template-columns:minmax(0,1fr)260px!important;grid-template-areas:"head head" "total pad" "customer pad" "loyalty pad" "method pad" "promptpay pad" "received pad" "change pad" "error error" "actions actions"!important;gap:10px 14px!important;align-items:start!important}#paymentDialog .payment-form.has-pos-pad .dialog-head{margin-bottom:12px!important;padding-top:14px!important;padding-bottom:12px!important}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-panel{grid-area:promptpay!important;margin-top:0;padding:10px 12px;grid-template-columns:minmax(0,1fr)96px}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-copy strong{font-size:20px}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-copy small{font-size:11px;line-height:1.3}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-qr-wrap{min-height:96px}.payment-form.has-pos-pad .promptpay-payment-qr{width:90px!important;height:90px!important}}
