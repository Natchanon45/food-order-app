...
function ensureStyle() {
  ...
  style.textContent = `
    ...
    @media(min-width:801px){#paymentDialog:has(.payment-form.has-pos-pad){width:min(840px,calc(100vw - 56px))!important;max-width:840px!important}#paymentDialog .payment-form.has-pos-pad{grid-template-columns:minmax(0,1fr)260px!important;grid-template-areas:"head head" "total pad" "customer pad" "loyalty pad" "method pad" "promptpay pad" "received pad" "change pad" "error error" "actions actions"!important;gap:8px 14px!important;align-items:start!important}#paymentDialog .payment-form.has-pos-pad .dialog-head{margin-bottom:6px!important;padding-top:12px!important;padding-bottom:10px!important}#paymentDialog .payment-form.has-pos-pad .payment-total{min-height:72px!important;padding:14px 20px!important}#paymentDialog .payment-form.has-pos-pad .payment-total strong{font-size:28px!important}#paymentDialog .payment-form.has-pos-pad .customer-picker{margin-top:0!important}#paymentDialog .payment-form.has-pos-pad .customer-search-wrap{margin-top:4px!important}#paymentDialog .payment-form.has-pos-pad .customer-search-input{min-height:42px!important}#paymentDialog .payment-form.has-pos-pad .customer-selected-note{margin-top:4px!important;font-size:.72rem!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox{padding:8px 10px!important;border-radius:12px!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox .loyalty-head strong{font-size:.9rem!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox .loyalty-head span{font-size:.72rem!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox .loyalty-controls{margin-top:6px!important;gap:6px!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox .loyalty-controls input{min-height:42px!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox .loyalty-controls button{min-height:42px!important;padding:0 12px!important}#paymentDialog .payment-form.has-pos-pad #loyaltyBox .loyalty-note{margin-top:4px!important;font-size:.7rem!important;line-height:1.2!important}#paymentDialog .payment-form.has-pos-pad label:has(#paymentMethod){margin-top:0!important}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-panel{grid-area:promptpay!important;margin-top:0;padding:8px 10px;grid-template-columns:minmax(0,1fr)82px;gap:10px}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-copy{gap:2px}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-copy span{font-size:12px}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-copy strong{font-size:20px}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-copy small{font-size:11px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#paymentDialog .payment-form.has-pos-pad .promptpay-payment-qr-wrap{min-height:82px}.payment-form.has-pos-pad .promptpay-payment-qr{width:76px!important;height:76px!important}#paymentDialog .payment-form.has-pos-pad #receivedWrap{margin-top:0!important}#paymentDialog .payment-form.has-pos-pad #receivedInput{min-height:48px!important}#paymentDialog .payment-form.has-pos-pad .change-row{padding:10px 12px!important}#paymentDialog .payment-form.has-pos-pad .change-row strong{font-size:20px!important}.payment-form.has-pos-pad .pos-number-pad{padding:10px!important;gap:7px!important}.payment-form.has-pos-pad .pos-number-pad button{min-height:44px!important}}
