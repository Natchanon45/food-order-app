...
Completed in this build: POS UI font-weight tuning for buttons, forms, Customer Display, receipt toolbar/modal, and tax invoice history/toolbar while preserving paper document font rules.
