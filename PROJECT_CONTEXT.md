...
Change: lightened the Customer Display green liquid-glass theme so the page feels more transparent and less opaque while preserving the richer hover QR glass panel, cart count readability, and PromptPay layout.
