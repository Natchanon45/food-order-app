...
Change: fixed the Customer Display device-pairing QR hover panel so it renders above the display content by giving the header/pairing layer an explicit top stacking order while preserving the white, green, and black liquid-glass PromptPay layout.
