...
Change: restored Customer Display to a classic green theme with white page background, solid green action bar, green text and borders, and no gradient/glass treatment for the cart, PromptPay QR panel, or pairing QR panel.
